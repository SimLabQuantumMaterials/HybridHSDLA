...
C     ..
C     .. Local Variables ..
      INTEGER i,j,jspin,neig,nk,nelec,ncr,ntet
      REAL    elow,dlow,eup,dup,ttt,dfermi,wgs
C     ..
C     .. Local Arrays ..
      REAL weight(4),ecmax(2,neigd)
      REAL wght(2,nkptd,neigd),eval(4)
C     ..
      DO neig = 1,neigd
        DO jspin = 1,jspins
...
c
     ...
     +          ttt = ecmax(jspin,neig) - eig(neig,nk,jspin)
      ...
      IF (dlow.GT.nelec) THEN    
        ...
        STOP 'dos: valence band too high '
      ENDIF
