...
c     
c     .. Local Scalars ..
      INTEGER n,i,c,n1,n2,n3,fill,fill1,zmax,xmax,ymax
      REAL lentn,t3
...
c------------------------------------------------------------------
      ...
      IF (film) THEN  !Added for Film-Jij calculations 10/23/06 bh
       zmax=0 ; ymax=20  ; xmax=20  ; t3 = 0
      ELSE
       zmax=nmax ; ymax=nmax ; xmax=nmax ; t3 = t(3)
      END IF 
...
c --------------------------------------------------
 ...
 5519 FORMAT(3(1x,f14.10))
      ...
      IF (nsh.GT.c) THEN
        STOP 'nshell: nsh greater than dimensioned;
     &  increase nmax in jcoff2'
      ENDIF
