...
C
     ...
     +                  i3*rcmt(i,3)/n3
            ...
            ENDDO
            ncd = ncd + 1
            IF (ncd.GT.48*mkpt) STOP 'kvecon: ncd>ncmax'
            DO i = 1, 3
              cand(i,ncd)=knew(i)
            ENDDO 
  200       CONTINUE
        ...
        ENDDO
      ENDDO
      IF (ncd.LT.nkpt) STOP 'kvecon: ncd<nkpt'
...
C
      ...
      xmin=1.0e6
      do 4200 n1=1,ncorn-2
      do 4200 n2=n1+1,ncorn-1
