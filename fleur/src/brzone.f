...
c
 ...
 7100 FORMAT (///,'  the irreducible wedge of the first brillouin'
     ...
     $     i10,'     edges           ',/,
     $     i10,'     faces           ')
      IF ( (ncorn + nface - nedge).NE.2 ) STOP 'bzone6'
